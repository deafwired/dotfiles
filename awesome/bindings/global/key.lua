...
awful.keyboard.append_global_keybindings {
   ...
   awful.key {
      ...
      group       = 'launcher',
      on_press    = function() awful.util.spawn("rofi -show drun -show-icons") end,
   },
   awful.key {
      modifiers = { mod.super },
      key = "c",
      ...
      group = 'launcher',
      on_press = function() awful.util.spawn("code") end,
   },
   awful.key {
      modifiers = { mod.super },
      key = "\\",
...
awful.keyboard.append_global_keybindings {
   awful.key {
      ...
      group       = 'audio',
      on_press    = function() awful.spawn("pactl set-sink-mute 0 toggle") end,
   },
   awful.key {
      modifiers   = {},
      key         = '#122',
